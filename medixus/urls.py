...
api_v1_urlpatterns = [
    # path(
    #     # include(("medixus.apps.accounts.api.v1.urls", "accounts"), namespace="api-v1-accounts"),
    #     # include(("medixus.apps.accounts.api.v1.urls", "referral"), namespace="api-v1-accounts"),
    # )
]
...
urlpatterns = [
    ...
    re_path(r'api/', include('medixus.apps.referral.urls')),
    re_path(r'api/', include('medixus.apps.new_feature.urls')),
]

# enable Swagger
if "SWAGGER" in settings.MEDIXUS_FEATURES:
    ...
    api_v1_schema_view = get_schema_view(
        openapi.Info(
            title="medixus",
            default_version="v1",
            description="medixus API v1 description",
        ),
        public=True,
